...
<div align="center">
  ...
  <div>
    ...
    <i>A language for efficient payments</i>
  </div>
  <br/>
  <div>
    <a href="https://github.com/gled-genpaylabs/genpay/releases/latest"><img src="https://img.shields.io/badge/dynamic/toml?url=https://github.com/gled-genpaylabs/genpay/blob/main/Cargo.toml%3Fraw%3Dtrue&query=workspace.package.version&logo=hackthebox&logoColor=fff&label=version&color=%2319a63e" /></a>
...
3. Unpack it anywhere and add to your `PATH` variable.
5. Restart the SHELL  on the  environment.
